...
const INT ROLE_LEAVE_PVP_INSTANCE_TICK_COUNT_DOWN	= 60 * TICK_PER_SECOND;		// 角色在副本内离开家族时，传送出副本的倒计时，60秒

#include "map.h"
#include "instance_define.h"

class map_instance_pvp : public map_instance
{
public:
	map_instance_pvp(void);
	virtual ~map_instance_pvp(void);
